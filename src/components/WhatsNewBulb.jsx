              ...
              <div className="p-6 space-y-4">
                ...
                <ul className="space-y-3">
                  ...
                  <li className="flex gap-3 items-start">
                    <CheckCircle2 className="w-5 h-5 text-cyan-400 shrink-0 mt-0.5" />
                    <div>
                      <h4 className="text-sm font-bold text-white">Seamless Routing</h4>
                      <p className="text-xs text-muted-foreground mt-1 leading-relaxed">Improved navigation and routing precision across the Vision portfolio and system alerts.</p>
                    </div>
                  </li>
                </ul>
              </div>
